...
#define MAJU_THINGSPEAK_ENABLE_ENV        1
#define MAJU_THINGSPEAK_URL_ENV           "https://api.thingspeak.com/update.json"
#define MAJU_THINGSPEAK_WRITE_API_KEY_ENV "TEST_KEY_1234567"
